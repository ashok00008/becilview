...
<body>
    ...
    <div class="fluid-container" style="margin: 20px 10px; max-width: 550px; margin:auto ;">
        <div class="">
            <div class="container-fluid">
                ...
                {{-- <div class="img-2" style="float: right;">
                    <img src="https://beciljobs.com/assets/public/asset/img/naukariyaan.png" class="logo2"
                            width="150px">
                </div> --}}
            </div>
        </div><br><br><br>
        <div class="container"  style="padding: 0px 10px;">
            ...
            <h5>You have been registered successfully for {{ $course_name }} course, vide registration number {{ $reg_code }}. Your Batch may start from the first week of the month in your preferred batch shift.</h5>
